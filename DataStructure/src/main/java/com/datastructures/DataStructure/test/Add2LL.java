package com.datastructures.DataStructure.test;
...
public class Add2LL {
	...
	private Node tail;
	private int size;
	Add2LL List1 = new Add2LL();
	Add2LL List2 = new Add2LL();
	Add2LL List3 = new Add2LL();
	...
	public void insert(int element1,int element2) {
		//while(i!=)
